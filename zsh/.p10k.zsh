...
() {
  ...
  unset -m '(POWERLEVEL9K_*|DEFAULT_USER)~POWERLEVEL9K_
...
GITSTATUS_DIR'
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='󰒋 ⇢ Carlos Moshu |'
  # typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%n@%m'
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='󰒋 %n en %m'
